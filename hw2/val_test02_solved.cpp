...
//
  for ( i = 0; i < 10; i++ ) // we need to initialize the value if it'll be printed or computed with
  { // we will compute in line 97 and print in line 104, so we have to initialize all
    x[i] = i;
  }
//
//  Copy some values.
